...
2. In Resend dashboard, add your sending domain: gougealert.com
...
- TXT (DKIM selector): <selector>._domainkey.gougealert.com  TXT  "v=DKIM1; k=rsa; p=..."
...
curl https://api.resend.com/emails \
  ...
  -d '{
    "from": "Hello <hello@gougealert.com>",
...
- Add DMARC TXT policy if you want: v=DMARC1; p=none; rua=mailto:postmaster@gougealert.com

If you want, I can generate the exact DNS records once you add gougealert.com to Resend and paste the returned DKIM/verification strings here for me to write to Cloudflare.
