...
1. **Frequent change orders** (4+ change orders on a $20K project)
2. **Vague explanations** (can't/won't provide details on what you're paying for)
3. **Pressure tactics** ("We need to decide NOW or the project stops")
4. **Work proceeding without approval** ("We already fixed it, so you owe us $X")
5. **Verbal-only change orders** (refuses to put it in writing)
...
**Protect yourself:**
1. Detailed contract upfront
2. Written approval for all changes
3. Itemized breakdowns
4. Second opinions on major changes
