...
export default function ReportPage() {
  ...
  // PDF download handler — captures rendered report from the DOM
  const handleDownloadPdf = useCallback(async () => {
    ...
    try {
      ...
      // Reset filter to show all items for PDF
      const prevFilter = activeFilter;
      const prevSort = sortByIssues;
      setActiveFilter('all');
      setSortByIssues(false);

      // Small delay to let React re-render with all items
      ...
      try {
        ...
        if (!response.ok) throw new Error('Server PDF also failed');
